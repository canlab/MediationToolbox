...
% # change function name back to orig after beta testing
...
if domultilev
    ...
    [paths, sterrs, b1betas, b2betas, b3betas, cpbetas, cbetas, residm1, residm2, residy, residy2, Vxm1, Vm1m2, Vm2y, Vxy]...
        = ols_mediation_paths_withstes(x, y, m1, m2, intcpt, n, logistic_Y);
else
    % single-level case
    [paths, sterrs, b1betas, b2betas, b3betas, cpbetas, cbetas, residm1, residm2, residy, residy2, Vxm1, Vm1m2, Vm2y, Vxy]...
        = ols_mediation_paths(x, y, m1, m2, intcpt, n, logistic_Y);
end
end
...
% -------------------------------------------------------------------------
% Compute path coefficients for OLS regression for single-level
% -------------------------------------------------------------------------
function [paths,sterrs,b1betas,b2betas,b3betas,cpbetas,cbetas,residm1,residm2,residy,residy2,Vxm1,Vm1m2,Vm2y,Vxy] = ols_mediation_paths(x, y, m1, m2, intcpt, n, logistic_Y)
