...
%
%   P = rectAsPolygon(circle, N);
%   convert circle given as [x0 y0 w h] or [x0 y0 w h theta] into an array
%   of  [Nx2] double, containing coordinate of retangle vertices.
%
%   See also :
%   drawRect, drawRect2, drawPolygon
%
%
%   ---------
%
