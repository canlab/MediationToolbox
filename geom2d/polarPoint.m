...
%
%   POINT = polarPoint(RHO, THETA) : THETA is angle with horizontal
%   (counted counter-clockwise, and in radians), and RHO is the radius.
%
%   POINT = polarPoint(THETA) : Only specify angle, radius RHO is assumed
%   to be 1.
%
%   POINT = polarPoint(POINT, RHO, THETA)
%   POINT = polarPoint(X0, Y0, RHO, THETA)
%   Add the coordinate of the point to the coordinate of the specified
