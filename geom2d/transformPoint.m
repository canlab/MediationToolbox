...
%                            [0 0 1]
%
%   PT2 = transformPoint(PT1, TRANS) also wotk when PTA is a [N*2] array of
%   double. In this case, PT2 has the same size as PT1.
%
%   [PX2 PY2] = transformPoint(PX1, PY1, TRANS) 
%   Also work when PX1 and PY1 are arrays the same size. The function
